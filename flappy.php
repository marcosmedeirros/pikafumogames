...
<head>
    ...
    <style>
        ...
        .saldo-badge { background-color: #00e676; color: #000; padding: 5px 15px; border-radius: 20px; font-weight: 800; }
...
<div id="game-wrapper">
    ...
    <div id="game-over-screen" class="overlay-screen" style="display: none;">
        ...
        <button class="btn btn-outline-light w-100 rounded-pill" onclick="location.reload()">Menu Principal</button>
    </div>
</div>
...
<script>
    ...
    // CONFIGURAÇÕES DE CENÁRIOS (NOVO - A cada 15)
    const scenarios = [
    ...
    const bird = {
        ...
        draw: function() {
            ...
            ctx.fillStyle = (currentSkin == 'robo') ? '#f00' : '#000'; // Olho vermelho pro robô
        ...
        update: function() {
            ...
            for(let i=0; i<this.items.length; i++) {
                ...
                if(p.x + this.w < bird.x && !p.passed) {
                    ...
                    // LÓGICA DE CENÁRIO (Atualizado para 15)
                    if(score % 15 === 0) {
                        let idx = Math.floor(score / 15) % scenarios.length;
